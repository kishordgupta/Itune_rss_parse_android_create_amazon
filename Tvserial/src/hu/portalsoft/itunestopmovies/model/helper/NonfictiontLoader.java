 ...
 *
 */
public class NonfictiontLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = NonfictiontLoader.class.getSimpleName();
	public static  String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";

	public NonfictiontLoader(Context context) {
		super(context);
	}
	
	public NonfictiontLoader(Context context,String Url) {
		super(context);
		WebURL=Url;
	}
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	//reset model
        	URLlist.Nonfiction= new Model();
        	//reset last update timestamp
        	URLlist.Nonfiction.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	URLlist.Nonfiction.setMovies(modelMovies);
        	//
