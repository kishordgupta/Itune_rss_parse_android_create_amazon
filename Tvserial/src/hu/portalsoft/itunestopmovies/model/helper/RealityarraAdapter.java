 ...
 *
 */
public class RealityarraAdapter extends ArrayAdapter<ITunesMovie> {
    
	/**
	 * Tag for logging
	 */
	private static final String TAG = RealityarraAdapter.class.getSimpleName();
	
	String webdata="";
	private final LayoutInflater mInflater;
    
	public RealityarraAdapter(Context context, int resource, List<ITunesMovie> objects) {
  ...
  /**
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.wa.loadData(D.replace("#XX#",URLlist.Reality.getMovieByPosition(position).getTitle().replaceAll(".*-", "").replace(" ","%20") ), "text/html", "utf-8");
      ...
      //  viewHolder.rankTextView.setText("" + (1 + position));
        ...
        viewHolder.rankTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 ITunesMovie movie =  URLlist.Reality.getMovieByPosition(Integer.parseInt(v.getTag()+""));
