 ...
 *
 */
public class SportsMovieListLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = SportsMovieListLoader.class.getSimpleName();
	public static  String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";

	public SportsMovieListLoader(Context context) {
		super(context);
	}
	
	public SportsMovieListLoader(Context context,String Url) {
		super(context);
		WebURL=Url;
	}
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	//reset model
        	URLlist.Sports= new Model();
        	//reset last update timestamp
        	URLlist.Sports.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	URLlist.Sports.setMovies(modelMovies);
        	//
