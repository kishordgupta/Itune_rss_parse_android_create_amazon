 ...
 *
 */
public class AllMovieListLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = AllMovieListLoader.class.getSimpleName();
	public static  String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";

	public AllMovieListLoader(Context context) {
		super(context);
	}
	
	public AllMovieListLoader(Context context,String Url) {
		super(context);
		WebURL=Url;
	}
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	//reset model
        	URLlist.All=new Model();
        	//reset last update timestamp
        		URLlist.All.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	URLlist.All.setMovies(modelMovies);
        	//
