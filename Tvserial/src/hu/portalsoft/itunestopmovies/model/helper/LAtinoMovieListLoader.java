 ...
 *
 */
public class LAtinoMovieListLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = LAtinoMovieListLoader.class.getSimpleName();
	public static  String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";

	public LAtinoMovieListLoader(Context context) {
		super(context);
	}
	
	public LAtinoMovieListLoader(Context context,String Url) {
		super(context);
		WebURL=Url;
	}
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	//reset model
        	URLlist.LAtino= new Model();
        	//reset last update timestamp
        	URLlist.LAtino.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	URLlist.LAtino.setMovies(modelMovies);
        	//
