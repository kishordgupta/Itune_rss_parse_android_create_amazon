 ...
 *
 */
public class ClassicActionMovieListLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = ClassicActionMovieListLoader.class.getSimpleName();
	public static  String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";

	public ClassicActionMovieListLoader(Context context) {
		super(context);
	}
	
	public ClassicActionMovieListLoader(Context context,String Url) {
		super(context);
		WebURL=Url;
	}
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	//reset model
        	URLlist.Classic= new Model();
        	//reset last update timestamp
        	URLlist.Classic.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	URLlist.Classic.setMovies(modelMovies);
        	//
