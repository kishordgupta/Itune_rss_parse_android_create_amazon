 ...
 *
 */
public class AnimationArrayAdapter extends ArrayAdapter<ITunesMovie> {
    
	/**
	 * Tag for logging
	 */
	private static final String TAG = AnimationArrayAdapter.class.getSimpleName();
	
	String webdata="";
	private final LayoutInflater mInflater;
    
	public AnimationArrayAdapter(Context context, int resource, List<ITunesMovie> objects) {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.wa.loadData(D.replace("#XX#",URLlist.Animation.getMovieByPosition(position).getTitle().replaceAll(".*-", "").replace(" ","%20") ), "text/html", "utf-8");
        ...
        viewHolder.rankTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 ITunesMovie movie =  URLlist.Animation.getMovieByPosition(Integer.parseInt(v.getTag()+""));
