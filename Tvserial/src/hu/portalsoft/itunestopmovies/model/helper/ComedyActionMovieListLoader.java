 ...
 *
 */
public class ComedyActionMovieListLoader extends AsyncTaskLoader<List<ITunesMovie>> {

	/**
	 * Tag for logging
	 */
	private static final String TAG = ComedyActionMovieListLoader.class.getSimpleName();
	public static  String WebURL ="https://itunes.apple.com/us/rss/topmovies/limit=100/json";

	public ComedyActionMovieListLoader(Context context) {
		super(context);
	}
	
	public ComedyActionMovieListLoader(Context context,String Url) {
		super(context);
		WebURL=Url;
	}
	...
	public List<ITunesMovie> loadInBackground() {
        ...
        try {
        	...
        	//reset model
        	URLlist.Comedy= new Model();
        	//reset last update timestamp
        	URLlist.Comedy.setLastUpdateTimestamp(modelLastUpdateTimestamp);
        	//reset movies
        	URLlist.Comedy.setMovies(modelMovies);
        	//
